...
public class PDPConstraintFactory {
	...
	private Constraint<TaskValue> constraint2() {
		Constraint<TaskValue> constraint = new Constraint<TaskValue>() {
	...
	//Check that a vehicle that pickups delivers the task and that it delivers it after picking it up
	private Constraint<TaskValue> constraint3() {
		Constraint<TaskValue> constraint = new Constraint<TaskValue>() {
	...
	private Constraint<TaskValue> constraint4() {
		Constraint<TaskValue> constraint = new Constraint<TaskValue>() {
	...
	private Constraint<TaskValue> constraint5() {
		Constraint<TaskValue> constraint = new Constraint<TaskValue>() {
	...
	private Constraint<TaskValue> constraint6() {
		Constraint<TaskValue> constraint = new Constraint<TaskValue>() {
	...
	private Constraint<TaskValue> constraint7() {
		Constraint<TaskValue> constraint = new Constraint<TaskValue>() {
